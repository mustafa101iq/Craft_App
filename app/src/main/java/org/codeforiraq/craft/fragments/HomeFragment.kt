...
//        list_skill.add(ListSkill("مطور تطبيقات","مصطفى الحمداني","200IQD"
...
//                ,"http://i.imgur.com/DvpvklR.png"))
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                if (selectProvince == "جميع المحافظات") {
                    set_up_recyclerView(birth_day, details, email, id, phone_number, photo_url, price, uid, user_name, user_skill, province)
    ...
    private fun set_up_recyclerView(birth_day: String, details: String, email: String, id: String, phone_number: String,
                                    photo_url: String, price: String, uid: String, user_name: String, user_skill: String, province: String) {
